...
$(document).ready(function () {
   ...
   $("#data").on('submit',function(){
    ...
    var breadcrumb = '<li class="first"><a href="../index.html" style="z-index:9;"><span></span>Home</a></li>\
                            <li class="first"><a href="index.html" style="z-index:8;"><span></span>Admin</a></li>\
                            <li class="first"><a href="#" style="z-index:7;"><span></span>Plates List</a></li>';
